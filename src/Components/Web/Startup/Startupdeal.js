          ...
          <Row>
            ...
            <Col md={6}>
              <div className="maindesign">
                      ...
                      <div className="profile_head d-flex justify-content-between">
                        ...
                        >
                          <div className="d-flex m-0 mb-3 justify-content-between">
                            ...
                            <p className="m-0  border border-dark text-dark rounded p-2 px-4">
                              Pending
                            </p>
                          </div>
                          <Row className="">
                      ...
                      <div className="profile_head d-flex justify-content-between">
                        ...
                        >
                          <div className="d-flex m-0 mb-3 justify-content-between">
                            ...
                            <p className="m-0 bg_red text-white p-2 px-4">
                              Rejected
                            </p>
                          </div>
                          <Row className="">
                      ...
                      <div className="profile_head d-flex justify-content-between">
                        ...
                        >
                          <div className="d-flex m-0 mb-3 justify-content-between">
                            ...
                            <p className="m-0 bg-transparent text-dark border border-dark p-2 px-4">
                              Pending
                            </p>
                          </div>
                          <Row className="">
                ...
                <p className="text-dark font_bolder text-center">View More</p>
              </div>
            </Col>
            <Col md={3}>
              <Card
